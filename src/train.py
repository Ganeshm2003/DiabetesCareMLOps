...
import sys
# Fix relative imports for running from root
...
from sklearn.metrics import accuracy_score  # For explicit accuracy
import joblib  # For artifacts
...
tracking_uri = "https://dagshub.com/Ganeshm2003/DiabetesCareMLOps.mlflow"
